...
Lightning.dragPoints = dragPoints;
...
Lightning.configure = function() {
    ...
    var lightningNoiseOpts = { base: 60, amplitude: 0.2, speed: 0.05 };
    var childNoiseOpts     = { base: 30, amplitude: 0.8, speed: 0.08 };
...
Lightning.addNode = function(x, y) {
  dragPoints.push(new DragPoint(x, y));
}

Lightning.removeNodes = function() {
  dragPoints = [];
}

Lightning.start = function() {
    Lightning.active = true;
}

Lightning.stop = function() {
...
Lightning.draw = function() {
    ...
    drawLightningLine(lightningLine, 0, 1, 0, 2);
    drawLightningCap(lightningLine);

    lightningLine.eachChild(function(child, i) {
        drawLightningLine(child, 0, 1, 0, 2);
